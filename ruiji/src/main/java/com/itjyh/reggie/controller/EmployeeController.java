...
@PostMapping("/login")
    public R<Employee> login(HttpServletRequest request, @RequestBody Employee employee){
        //Json形式接收加@RequestBody 注解;加入HttpServletRequest ,将employee对象存入session中,方便登录
...
//       等值查询
        ...
        Employee emp = employeeService.getOne(queryWrapper);   //username在数据库表中定义为唯一的,,可以用getOne
